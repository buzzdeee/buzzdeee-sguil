...
1. [Setup - The basics of getting started with sguil](#setup)
    * [What sguil affects](#what-sguil-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with sguil](#beginning-with-sguil)
